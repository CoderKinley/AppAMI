...
{
    /// <summary>
    /// Interaction logic for ReportMeter.xaml
    /// </summary>
    public partial class ReportMeter : UserControl
    {
        ...
        public ReportMeter(string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1, string DTId1)
        {
            InitializeComponent();
        ...
        private async Task ReadDatabase()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(txtDtId.Text))
                {
                    ...
                    {
                        string url = string.Format("http://103.234.126.43:3080/reports/dt/{0}", txtDtId.Text);

                        string json = await web.DownloadStringTaskAsync(url);

                        List<ReportDt> all_data = JsonConvert.DeserializeObject<List<ReportDt>>(json);

                        // Filter data based on date range using the format "yyyy-MM-dd"
                        List<ReportDt> filtered_data = all_data
                            .Where(x => DateTime.ParseExact(x.trip_date, "yyyy-MM-dd", CultureInfo.InvariantCulture) >= dtPickerStart.SelectedDate.Value
                        ...
                        {
                            reportsDgv.ItemsSource = filtered_data;
                        });
        ...
        private async void btnSendEmail_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                using (SmtpClient smtpClient = new SmtpClient("smtp.gmail.com"))
                {
                    ...
                    var excelEngine = reportsDgv.ExportToExcel(reportsDgv.View, options);
                    ...
                    attachment.Name = "Report_" + txtDtId.Text + "_From_" + dtPickerStart.Text + "_To_" + dtPickerEnd.Text + ".xlsx";
        ...
        private void MenExportXls_Click(object sender, RoutedEventArgs e)
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog
            {
                ...
                FileName = "Reports_" + txtDtId.Text + "_From_" + dtPickerStart.Text + "_To_" + dtPickerEnd.Text + ".xlsx"
        ...
        private void menExportCsv_Click(object sender, RoutedEventArgs e)
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog
            {
                ...
                FileName = "Reports_" + txtDtId.Text + "_From_" + dtPickerStart.Text + "_To_" + dtPickerEnd.Text + ".csv"
        ...
        {
            var document = reportsDgv.ExportToPdf();
            SaveFileDialog sfd = new SaveFileDialog
            {
                Filter = "PDF Files(*.pdf)|*.pdf",
                FileName = "Reports_" + txtDtId.Text + "_From_" + dtPickerStart.Text + "_To_" + dtPickerEnd.Text + ".pdf"
