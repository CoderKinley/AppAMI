...
{
    /// <summary>
    /// Interaction logic for ViewMeterWindow.xaml
    /// </summary>
    public partial class ViewMeterWindow : Window
    {
        DT selectedDt;
        ...
        public ViewMeterWindow(DT selectedDt, string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1)
        {
            InitializeComponent();
            ...
            txtMeterSerialNo.Text = this.selectedDt.dt_meter_serial_no;
            cbMeterType.Text = this.selectedDt.meter_type;
            cbMeterFirmwareVer.Text = this.selectedDt.meter_firmware_version;
            dtMeterManuYear.Text = this.selectedDt.meter_manufacturing_year;
            dtMeterInstallationDate.Text = this.selectedDt.meter_installation_date;

            // lblCurrentUserRole.Content = currentUserRole;
        ...
        private async void addNewUserEvent()
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    MessageBox.Show("Meter successfully updated.", "Success Notification", MessageBoxButton.OK, MessageBoxImage.Information);
