...
{
    /// <summary>
    /// Interaction logic for DeleteDtWindow.xaml
    /// </summary>
    public partial class DeleteDtWindow : Window
    {
        DT selectedDt;
        ...
        public DeleteDtWindow(DT selectedDt, string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1)
        {
            InitializeComponent();
            ...
            txtTotalConsyumerCount.Text = this.selectedDt.total_customer_count;
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Error deleting DT configuration. Please check the details and try again.", "Update Error", MessageBoxButton.OK, MessageBoxImage.Error);
                    }
                }
        ...
        private async void addNewUserEvent()
        {
            ...
            try
            {
                ...
                {
                    GetDtIdAutoSuggest();
                    MessageBox.Show("DT successfully deleted.", "Success Notification", MessageBoxButton.OK, MessageBoxImage.Information);
                    Close();
                }
                else
                {
