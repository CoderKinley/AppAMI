...
{
    /// <summary>
    /// Interaction logic for ViewMriWindow.xaml
    /// </summary>
    public partial class ViewMriWindow : Window
    {
        DT selectedDt;
        ...
        public ViewMriWindow(DT selectedDt, string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1)
        {
            InitializeComponent();
            ...
            cbMriVersion.Text = this.selectedDt.mri_version;

            cbMriFirmwareVer.Text = this.selectedDt.mri_firmware_version;
            dtMriManuYear.Text = this.selectedDt.mri_manufacturing_year;
            dttxtMriInstallationDate.Text = this.selectedDt.mri_installation_date;
