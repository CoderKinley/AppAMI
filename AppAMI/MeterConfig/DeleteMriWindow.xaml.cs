...
{
    /// <summary>
    /// Interaction logic for DeleteMriWindow.xaml
    /// </summary>
    public partial class DeleteMriWindow : Window
    {
        Mri  selectedDtMri;
        ...
        public DeleteMriWindow(Mri  selectedDtMri, string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Error deleting MRI configuration. Please check the details and try again.", "Update Error", MessageBoxButton.OK, MessageBoxImage.Error);
                    }
        ...
        private async void addNewUserEvent()
        {
            ...
            try
            {
                UserEventPost userEventPost = new UserEventPost()
                {
                    ...
                    Remarks = "Deleted Mri for : " + txtDTId.Text,
                };
                ...
                if (response.IsSuccessStatusCode)
                {
                    MessageBox.Show("MRI successfully deleted.", "Success Notification", MessageBoxButton.OK, MessageBoxImage.Information);
