...
{
    /// <summary>
    /// Interaction logic for AddDtWindow.xaml
    /// </summary>
    public partial class AddDtWindow : Window
    {
        ...
        public AddDtWindow(string esdCode, string CurrentUserId1, string CurrentUserRole1, string CurrentUserPassword1, string CurrentUserName1, string CurrentUserEmployeeId1)
        {
            InitializeComponent();
        ...
        async void btnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string url = "http://103.234.126.43:3080/dtmeter/district/post/DT";
